...
from . import data
from .common import format_dict, format_json, format_msgpack, format_toml, format_tuple, format_yaml, all_formats, type_ids, types, opt_case, opt_case_ids
...
def test_tuple(se, de, opt):
    ...
    if se is not serde.toml.to_toml:
        p = Nested((data.Int(10), data.Int(20)), (data.Str("a"), data.Str("b")), (data.Float(10.0), data.Float(20.0)), (data.Bool(True), data.Bool(False)))
